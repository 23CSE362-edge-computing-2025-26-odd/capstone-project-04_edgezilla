# ====================================================================
# GA_Optimize_Sepsis.py
# Genetic Algorithm-based Hyperparameter Optimization for GRU Model
# ====================================================================
...
parser.add_argument("--pop", type=int, default=20, help="Population size (default=20)")
...
# ✅ Custom safe mutation (no invalid values)
def custom_mutate(individual):
    if random.random() < 0.2:
        individual[0] = random.choice([64, 128, 256])   # hidden_dim
    if random.random() < 0.2:
        individual[1] = random.choice([1, 2, 3])        # num_layers
    if random.random() < 0.2:
        individual[2] = random.choice([0.2, 0.3, 0.5])  # dropout
    if random.random() < 0.2:
        individual[3] = random.choice([0.001, 0.0005, 0.0001])  # lr
    return (individual,)
...
# ====================================================================
# Step 6: Run GA with Best Pop & Gen
# ====================================================================
pop = toolbox.population(n=POP_SIZE)

log_message("[GA] Starting Genetic Algorithm optimization...")
