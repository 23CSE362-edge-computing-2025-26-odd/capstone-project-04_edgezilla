...
def check_ml_server_status():
    ...
    try:
        ...
        print("⚠️  ML Server: Not accessible at http://localhost:5002")
...
def validate_csv_data():
    ...
    try:
        ...
        if generator.data is not None:
            ...
            if missing_cols:
                print(f"⚠️  CSV Warning: Missing columns {missing_cols}")
                return False
            else:
                print("   All required columns present")
                return True
        else:
            print("⚠️  CSV Data: Not found, using synthetic data generation")
            return False
...
def main():
    ...
    print(f"⏱️  Simulation duration: {args.duration} seconds")
